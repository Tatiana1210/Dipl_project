...
<div id="enter_modal">
    ...
    <form id="auth_form" method="post" action="/Account/auth">
  ...
  <section class="navigation">
           <nav>
                     <ul class="top_nav">
                         ...
                         <li class="top"> <a class="top" href="/schedule"> Расписание курсов </a> </li>
                          <li class="top"> <a class="top" href="/price"> Цены и акции  </a> </li>
                          <li class="top"> <a class="top" href="/to_know_level_eng"> Узнать свой уровень  </a> </li>
                         <li class="top shoop"> <a class="top" href="/goods"> Интернет-магазин </a>
                            <ul class="level-2">
