...
<form id="eng_test" class=""  method="post">
<div  id="test_container">
  <label id="qw" class="test_level"><?php echo $questions['text_question'];?></label>
  <?php foreach ($answers as $key => $value):?>
  <ul class="check">
      <li class="check" id="selectlist">
          <input id="checkbox<?php echo $key+1;?>" type="checkbox" name="answer" value="<?php echo $key+1;?>"  style="width: 7vh; height:7vh; margin-left:2%; ">
          <span>
              <?php echo $value['text_answer'];?>
          </span>
      </li>
  </ul>
  <?php endforeach; ?>
  <a href="/testLevel/english/<?php echo $id_question-1 ? $id_question-1 : 1;?>"><img src="/img/prev.png"></a>
  <a href="/testLevel/english/<?php echo $id_question+1;?>"><img src="/img/next.png"></a>
 </div>
 <button type="submit" name="result_test" id="result_test">Узнать результат</button>
 </form>
<script src="/js/localstorage_ajax.js "></script>
