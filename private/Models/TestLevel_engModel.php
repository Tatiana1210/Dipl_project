...
public function getQuestion($id_question){  //controller/action/get
 ...
 public function getRightAnswer (){  //controller/action/get
         $sql_str = "SELECT correct_answer_v FROM $this->tablename1";
         return $this->db->fetchAllData($sql_str,$params);
     }

 public function check_results ($id_question){
